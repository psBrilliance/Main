#Not Created by knunke
# asynchronous IP range scanner   

# define the range   
[string]$firstThree = "10.108.70"   
[int]$startRange = "100"
[int]$endRange = "150"
...
$startRange..$endRange | %{   
        ...
        start-job -ArgumentList "$firstThree.$_" -scriptblock { $test = test-connection $args[0] -count 1 -quiet; return $args[0],$test } | Out-Null
